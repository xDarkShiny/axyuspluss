            ...
            msg.edit(':eight_pointed_black_star:| **Şimdi de ödülü yaz bakalım**').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  .setColor("#f558c9")
                  .setDescription(`<a:bluestar:772431181916536852> **Ödül: ${title}** \n<a:bluestar:772431181916536852> 🎉'a Basarak Katıl \n<a:bluestar:772431181916536852> Kalan Süre : ${duration} \n **Başlama Zamanı :** ${hours}:${minutes}:${seconds} ${suffix}`)
                  .setFooter(message.author.username + " (AxyUS + çekiliş sistemi)", message.author.avatarURL);
                  message.guild.channels.find("name" , room).send(' 🎉 **ÇEKİLİŞ BAŞLADI** 🎉' , {embed: giveEmbed}).then(m => {
                     ...
                     setTimeout(() => {
                       ...
                       .setTitle(title)
                       .setColor("#f558c9")
            .setFooter("(AxyUS + çekiliş sistemi)")
                     ...
                     m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});
                       ...
                       var embedLel = new Discord.RichEmbed()
                        .setColor("#f558c9")
                        .setDescription("Ödülünü Moderatörleri Etiketleyerek Alabilirsin!").setFooter("(AxyUS + çekiliş sistemi)")
