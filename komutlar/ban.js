...
message.channel.send(case1)
  ...
  .setColor(`GREEN`)
  .addField(`<a:ryzen_dcpersonel:777234741413543946> İşlem | Durum ${case1}`, 'Ban')
  .addField(`<a:bluediamond:772431166162075679> Banlanan üye`, `${user.tag} (${user.id})`)
  .addField(`<a:dcworker:772431285460664330> Banlayan yetkili`, `${message.author.username}#${message.author.discriminator}`)
  .addField(`<a:chromastar:772431261946871810> Ban sebebi`, "```" + reason + "```")
  modlog.send(embed);
  ...
  .setColor("RANDOM")
  .setDescription(`Kullanıcı Havaya Uçtu <:bangg:749338786009186344>`)
  .setImage("https://i.giphy.com/media/fe4dDMD2cAU5RfEaCU/giphy.gif")
