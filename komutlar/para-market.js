...
.setColor('RANDOM')
.setDescription(`${client.emojis.get('775731607364567061')} Rozeti: **50 ELMAS** (Satın Almak İçin: **${prefix}market rozet**)`)
message.channel.send(e)
    ...
    if (x === 'rozet') {
      ...
      const embed = new Discord.RichEmbed()
        .setDescription(`${client.emojis.get('769861387572609026')}Zaten sende rozet bulunuyor fazlasını ne yapacaksın?`)
    .setColor('RED')
      .setTimestamp()
      message.channel.send({embed})
        ...
        message.channel.send(`${client.emojis.get('769861387572609026')} Rozet satın almak için yeterli elmasın bulunuyor. \n Gerekli olan elmas: **${rozetF} ELMAS**.`)
    } else if  (rozetA > rozetF) {
message.channel.send(`${client.emojis.get('775731607364567061')} Rozetini başarıyla aldınız`)
...
db.add(`elmascıklar_${message.member.id}`, -50)
  ...
  message.channel.send(`${client.emojis.get('772431181916536852')} Rozetini başarıyla aldınız`)
  db.set(`memberBadge6_${message.author.id}`, "https://cdn.discordapp.com/attachments/531535859594297364/533260601162465280/paraR.png")
  db.add(`rozet_${message.author.id}`, 2)
  db.add(`elmascıklar_${message.member.id}`, -50)
      }
    ...
    if (x === 'kalem') {
      ...
      if (kalem > 0) {
      const embed = new Discord.RichEmbed()
      .setDescription(`${client.emojis.get('769861387572609026')} Zaten sende kalem eldiveni bulunuyor fazlasını ne yapacaksın?`)
      .setColor('RED')
      .setTimestamp()
      message.channel.send({embed})
        ...
        message.channel.send(`${client.emojis.get('769861387572609026')} Kalem satın almak için yeterli paran bulunuyor. \n Gerekli olan para: **250TL**.`)
    } else if  (para > 200) {
message.channel.send(`${client.emojis.get('769860723320684575')} :pencil2: Kalem başarıyla aldınız`)
