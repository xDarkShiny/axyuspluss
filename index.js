...
client.ayarlar = {
  oynuyor: "a!yardım | 📣 Sponsor Aranır",
  official_sahip: "543436148056260608",
  sahip: "543436148056260608",

  yardimcilar: [""],
  isim: "AxyUS +",
  botD:
    "https://discord.com/api/oauth2/authorize?client_id=764490067586318388&redirect_uri=https%3A%2F%2Fdum-tek.glitch.me%2Fcallback&response_type=code&scope=guilds%20identify",
  webS: "https://dum-tek.glitch.me/",
  web: "https://dum-tek.glitch.me/",
  site: "https://dum-tek.glitch.me/",
  dblO: "https://top.gg/bot/764490067586318388/vote",
  dbl: "https://top.gg/bot/764490067586318388",
  dbltoken:
        "764490067586318388",
  webpanel: "https://dum-tek.glitch.me/",
  versiyon: "2.0",
  prefix: "a!",
  renk: "RANDOM",
  version: "1.0.0"
...
client.avatarURL = `https://images-ext-1.discordapp.net/external/S0lQEVks5q4GnWX-yxvSUbDguoxjl0t1mdKxQvGWUAw/https/i.pinimg.com/originals/2f/24/22/2f2422161e2de4862678d7df1bb6b319.jpg?width=80&height=53`;
    ...
    if(user)
      {
        ...
        .setAuthor(`<a:ryzen_dikkat:777235820927123507> ${ben}, ${msg.guild.name} Sunucusunda ${msg.channel.name} kanalında sizi etiketledi.`, msg.author.avatarURL)
        .setColor("GREEN")
        .setTimestamp()
  ...
  if (db.has(`ss_${msg.guild.id}`) === true) {
    if (db.has(`üyelikk_${msg.author.id}`)) {
      if (msg.content.toLowerCase() === "sa") {
        msg.channel.send(
          `${client.emojis.get('762595553473200128')} **Aleyküm Selam Gold üye ${client.emojis.get('768474917552521216')} \`${msg.author.tag}\` Hoşgeldin**`
        );
      ...
      if (msg.content.toLowerCase() === "s.a") {
        msg.channel.send(
          `**Aleyküm Selam Gold üye \`${msg.author.tag}\` Hoşgeldin**`
        );
        db.add(`slmal_${msg.author.id}`, 1);
      }
      ...
      if (msg.content.toLowerCase() === "selamün aleyküm") {
        msg.channel.send(
          ` **Aleyküm Selam , \`${msg.author.tag}\` Hoşgeldin**`
        );
        db.add(`slmal_${msg.author.id}`, 1);
      }
    } else if (msg.content.toLowerCase() === "sa") {
      msg.channel.send(
        `**Aleyküm Selam Hoşgeldin ${msg.author}** <a:9_:760147754617143386>`
      );
      db.add(`slmal_${msg.author.id}`, 1);
...
client.on("guildCreate", guild => {
  const e = new Discord.RichEmbed()
    .setColor("RANDOM")
    .setDescription(
      "Heeeeeey Sonunda Axyus + Sunucuya Eklenmeyi başardı a!yardım yazarak bilgi alabilirsin."
    )
  .setImage("https://images-ext-1.discordapp.net/external/NuK-1Wn6PU93xuQDStRAmgdSVKuwI0JTFi-DKtqxu6o/https/images-ext-2.discordapp.net/external/ypX9NA6oamgnP3RTYnNi-f1c-ybAfi-jFWttpaCN9Do/https/media0.giphy.com/media/X2aJeBLbMAWkgx5ycZ/giphy.gif")
    ...
    if (kufur.some(word => msg.content.toLowerCase().includes(word))) {
      if (!msg.member.hasPermission("ADMINISTRATOR")) {
        ...
        var k = new Discord.RichEmbed()
          ...
          .setDescription(
            `Hey <@${msg.author.id}>, Bu sunucuda küfürler yasaktır.`
          );
    ...
    if (reklam.some(word => msg.content.toLowerCase().includes(word))) {
      if (!msg.member.hasPermission("ADMINISTRATOR")) {
        ...
        var ke = new Discord.RichEmbed()
          ...
          .setDescription(
            `Hey <@${msg.author.id}>, Bu sunucuda linkler yasaktır.`
          );
        ...
        if (kanalD === "var") {
          if (db.has(`üyelikk_${member.id}`)) {
            const embed = new Discord.RichEmbed()
              .setColor("RANDOM")
              .setDescription(
                `<a:onayl:769860723320684575> Gold üye katıldı. \`${member.user.tag}\`, Hoşgeldin \`${rol.name}\` Adlı rolün verildi`
              );
            ...
            member.guild.channels
              .get(db.fetch(`otoRK_${member.guild.id}`))
              .send(
                `<a:onayl:769860723320684575> <a:giri:769860432013164574> **${member.user.tag}** adlı kullanıcıya başarıyla otomatik rol olarak ayarlanmış olan \`${rol.name}\` adlı rol verildi!`
              );
        }
      }
    }
    ...
    if (db.fetch(`sayac_${message.guild.id}`) <= message.guild.members.size) {
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(
          ...
          )}\` kullanıcıya ulaştık! Sayaç sıfırlandı! <a:onayl:769860723320684575>`
        )
        .setColor("RANDOM");
    ...
    const embed = new Discord.RichEmbed()
      ...
      .setDescription(
        `Gold üye kayboldu. \`${
          ...
          member.guild.members.size}\` Kişi Kaldı <a:giri:769860432013164574>`
      );
    ...
    member.guild.channels
      ...
      .send(
        `**${
          ...
          member.guild.members.size}\` üye kaldı! <a:ciki:769861063243857940>`
      );
});
  ...
  if (db.has(`üyelikk_${member.id}`)) {
    member.guild.channels.get(hgK).send(
      db.has(`girisM_${member.guild.id}`)
        ...
        : `<a:onayl:769860723320684575> <a:giri:769860432013164574> <@${member.user.id}> Adlı Gold Üye Katıldı! adresinden veya (\`giriş-mesaj-ayarla\` komutu ile mesajı değiştirilebilir.`
    );
  } else
    member.guild.channels.get(hgK).send(
      db.has(`girisM_${member.guild.id}`)
        ? giris
            ...
            .replace("{sunucu}", `**${member.guild.name}**`)
            .replace("{kişisayısı}", `**${member.guild.members.size}**`)
        : `<a:onayl:769860723320684575> <a:giri:769860432013164574> <@${member.user.id}> Katıldı!  adresinden veya (\`giriş-mesaj-ayarla\` komutu ile mesajı değiştirilebilir.)`
    );
});
    ...
    member.guild.channels.get(hgK).send(
      db.has(`cikisM_${member.guild.id}`)
        ? cikis
            ...
            .replace("{sunucu}", `**${member.guild.name}**`)
            .replace("{kişisayısı}", `**${member.guild.members.size}**`)
        : `<a:no:769861387572609026> <a:ciki:769861063243857940> **${member.user.username}** Adlı Gold Üye Ayrıldı! adresinden veya (\`çıkış-mesaj-ayarla\` komutu ile mesaj değiştirilebilir.)`
    );
  } else
    member.guild.channels.get(hgK).send(
      db.has(`cikisM_${member.guild.id}`)
        ? cikis
            ...
            .replace("{sunucu}", `**${member.guild.name}**`)
            .replace("{kişisayısı}", `**${member.guild.members.size}**`)
        : `<a:no:769861387572609026> <a:ciki:769861063243857940> **${member.user.username}** Ayrıldı! adresinden veya (\`çıkış-mesaj-ayarla\` komutu ile mesaj değiştirilebilir.)`
    );
});
client.on("message", async message => {
  ...
  if (command === "rozet-parar") {
    if (message.author.id !== "775731607364567061")
    ...
    return message.channel.send(
      `${onay} Kullanıcıya yıldırım rozeti verilmiştir.`
    );
  }

  if (command === "rozet-onayla") {
    if (message.author.id !== "775731958969532427")
      return message.channek.send(
        `${red} Bu komutu kullanmak için yetkin bulunmuyor.`
      );
    const i = await db.set(
  ...
  if (command === "rozet-yetkili" || command === "rozet-ekip") {
    if (message.author.id !== "775732459408457769")
      return message.channel.send(
        `${red} Bu komutu kullanmak için yetkin bulunmuyor.`
      );
    const i = await db.set(
  ...
  if (command === "rozet-destekci" || command === "rozet-destekçi") {
    if (message.author.id !== "775736487718944778")
      return message.channel.send(
        `${red} Bu komutu kullanmak için yetkin bulunmuyor.`
      );
    const i = await db.set(
  ...
  if (command === "rozet-mod" || command === "rozet-moderator") {
    if (message.author.id !== "775736756590084106")
      return message.channel.send(
        `${red} Bu komutu kullanmak için yetkin bulunmuyor.`
      );
    const i = await db.set(
          ...
          msg.guild
            ...
            .then(c => {
              ...
              const embed = new Discord.RichEmbed()
                .setColor("RANDOM")
                .setAuthor(
                  `${client.user.username} | Destek Sistemi <a:onayl:769860723320684575>`,
                  client.user.avatarURL
                )
                .setTitle(`_Merhaba ${msg.author.username}!_`)
                .addField(
                ...
                .setFooter(
                  `${msg.guild.name} adlı sunucu ${client.user.username} Destek Sistemi'ni kullanıyor teşekkürler! <a:onayl:769860723320684575>`,
                  msg.guild.iconURL
                );
              c.send({ embed: embed });
              c.send(
...
client.on("message", async message => {
  ...
  if (message.content.toLowerCase().startsWith(prefix + `talep-kapat`)) {
    ...
    const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setAuthor(`Destek Talebi Kapatma İşlemi! <a:no:769861387572609026>`)
      .setDescription(
        `Destek talebini kapatma işlemini onaylamak için, \n10 saniye içinde \`evet\` yazınız. <a:no:769861387572609026>`
      )
      .setFooter(
        `${client.user.username} | Destek Sistemi`,
        client.user.avatarURL
...
const beklememesaji = `Bu komutu kullanabilmek için \`${sure}\` saniye kadar beklemelisiniz.`; //Komut bekleme mesajı
  ...
  if (REASON) {
    ...
    if (db.has(`üyelikk_${USER.id}`)) {
      ...
      const embed = new Discord.RichEmbed()
        ...
        .setDescription(
          `\`${USER.tag}\` Adlı Gold üyeyi rahatsız edemezsiniz.\nAFK süresi: \`${timeObj.hours}\`** saat** \`${timeObj.minutes}\`** dakika** \`${timeObj.seconds}\` ** saniye**\nSebep:\n\`${REASON}\``
        );
...
let i = db.fetch(`üyelikk_${msg.author.id}`)
  ...
  .setAuthor(`AxyUS +`,`${msg.author.avatarURL || msg.author.displayAvatarURL}`)
  .setDescription(`Gold Üye Belirdi! <@${msg.author.id}>`)
  .setColor("BLUE")
...
client.on("guildMemberAdd", async member => {
  ...
  gözelkanal.send("**"+member.user.username + "** adlı bota bir yetkili izin verdi eğer kaldırmak istiyorsanız **a!bot-izni-kaldır botunid**.")
  } else {
  gözelkanal.send("**" + member.user.username + "** adlı botu güvenlik amacı ile uzaklaştırdım. Tekrar geldiğinde uzaklaştırılmasını istemiyorsanız **a!bot-izni-ver botunid**")
  member.ban()
}
  }
});
...
.addField(`<a:ayarlar:772431128145559575> Giriş sebebin:`, sebepp) 
.addField(`<a:ayarlar:772431128145559575> AFK olma zamanın:`, sp)
.addField(`<a:chromastar:772431261946871810> Çıkış zamanın:`, atılma))
...
client.on('guildMemberAdd', async(member) => {
 let mute = member.guild.roles.find(r => r.name === "AxyUS + | Mute Sistemi");
let mutelimi = db.fetch(`muteli_${member.guild.id + member.id}`)
let süre = db.fetch(`süre_${member.id + member.guild.id}`)
if (!mutelimi) return;
if (mutelimi == "AxyUS + | Mute Sistemi") {
...
client.on("guildCreate", guild => {
  let log = client.channels.get("757523432995946506");
  const embed = new Discord.RichEmbed()
    .setAuthor("Yeni bir sunucuya eklendim! :)")
    .setThumbnail(
      guild.iconURL ||
        "https://images-ext-1.discordapp.net/external/NuK-1Wn6PU93xuQDStRAmgdSVKuwI0JTFi-DKtqxu6o/https/images-ext-2.discordapp.net/external/ypX9NA6oamgnP3RTYnNi-f1c-ybAfi-jFWttpaCN9Do/https/media0.giphy.com/media/X2aJeBLbMAWkgx5ycZ/giphy.gif"
    )
    .setColor("GREEN")
    ...
    .addField(
      "Sunucu Bilgisi:",
      `<a:bluediamond:772431166162075679> **Sunucu Sahibi: \`${guild.owner}\`\n<a:bluediamond:772431166162075679> Sunucu Bölgesi: \`${guild.region}\`\n<a:bluediamond:772431166162075679> Üye Sayısı: \`${guild.members.size}\`\n<a:bluediamond:772431166162075679> Kanal Sayısı: \`${guild.channels.size}\`**`
    )
    .setTimestamp()
...
client.on("message", msg => {
  var dm = client.channels.get("775687189043478548"); //mesajın geleceği kanal idsi//
...
client.on("ready", () => {
client.channels.get("779324261407916103").join()
})



client.login("NzY0NDkwMDY3NTg2MzE4Mzg4.X4HA2w.z8U80EQi6ZOnZP3sz8rc8O3PbCc");