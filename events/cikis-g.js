...
module.exports = async member => {  
  ...
  const background = await Canvas.loadImage('https://cdn.discordapp.com/attachments/744298981118574652/756492034487091230/wp2655430.png');
 ...
 const embed = new Discord.RichEmbed()
      ...
      .setDescription(
        `<a:bluestar:772431181916536852> ${member.user.username} Adlı Gold üye Ayrıldı. <a:bluestar:772431181916536852> `
      );
