...
let user = member.client.users.get(member.id);
  ...
  const background = await Canvas.loadImage('https://i.stack.imgur.com/HCXet.png');
...
ctx.beginPath();
 ...
 const embed = new Discord.RichEmbed()
      ...
      .setDescription(
        `<a:bluestar:772431181916536852> ${member.user.username} Adlı Gold üye Katıldı. <a:bluestar:772431181916536852>`
      );
